...
public class TransportSearchAction extends HandledTransportAction<SearchRequest, SearchResponse> {
    ...
    private final TransportSearchQueryNoFetchAction queryNoFetchAction;
    ...
    public TransportSearchAction(Settings settings, ThreadPool threadPool,
                                 ...
                                 TransportSearchQueryNoFetchAction queryNoFetchAction,
        ...
        this.queryNoFetchAction = queryNoFetchAction;
    ...
    protected void doExecute(SearchRequest searchRequest, ActionListener<SearchResponse> listener) {
        ...
        } else if (searchRequest.searchType() == SearchType.QUERY_NO_FETCH){
            queryNoFetchAction.execute(searchRequest, listener);
        }
    }
